    ...
    <>
      <section className="mx-auto max-w-6xl px-4 pb-12 pt-6 sm:px-6 sm:pt-12">
        <div className="mb-5 max-w-2xl sm:mb-8">
          ...
          <h1 className="text-3xl leading-tight sm:text-5xl">{siteConfig.tagline}</h1>
          <p className="mt-3 text-base text-sage-800 sm:text-lg">
            Spine width, full-cover dimensions, and safe-zone diagrams — instant, in-browser, and
            verified against KDP&rsquo;s official template.
          </p>
