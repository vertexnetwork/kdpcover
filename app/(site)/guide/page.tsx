  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <p className="mt-3 text-sage-800">
        KDP&rsquo;s reviewer checks geometry, bleed, safe zones, barcode placement, and file
        format. Every rejection we&rsquo;ve seen falls into one of seven buckets. Here they are,
        with the exact spec each one trips on.
      </p>

      <div className="mt-8 rounded-card border border-(--color-border) bg-(--color-surface) p-5 sm:p-6">
      ...
      <EmailCaptureForm source="guide" className="mt-12" />

      <p className="mt-12 rounded-card border border-(--color-border) bg-sage-50 p-5 text-sm text-sage-800">
